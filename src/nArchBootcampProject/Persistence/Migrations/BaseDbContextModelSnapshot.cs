            ...
            modelBuilder.Entity("Domain.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("5846b2bb-0ca1-4349-bcb1-634795a5aa33"),
                            AuthenticatorType = 0,
                            CreatedDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            ...
                            PasswordHash = new byte[] { 140, 104, 236, 94, 175, 228, 242, 238, 239, 114, 158, 184, 51, 59, 26, 207, 207, 217, 88, 141, 241, 20, 110, 107, 123, 70, 210, 238, 14, 10, 136, 74, 241, 67, 101, 29, 79, 126, 27, 93, 167, 56, 96, 183, 53, 72, 18, 105, 211, 115, 91, 209, 144, 187, 45, 181, 128, 55, 50, 253, 255, 219, 169, 164 },
                            PasswordSalt = new byte[] { 124, 148, 204, 120, 235, 220, 139, 32, 180, 99, 132, 74, 57, 58, 48, 248, 67, 142, 104, 151, 8, 97, 56, 170, 76, 69, 103, 220, 71, 148, 98, 201, 76, 181, 4, 145, 86, 185, 160, 35, 183, 61, 105, 57, 252, 78, 1, 218, 82, 154, 126, 33, 197, 217, 89, 225, 74, 244, 185, 109, 40, 109, 139, 181, 99, 165, 56, 134, 42, 159, 136, 104, 126, 38, 64, 198, 162, 54, 117, 177, 11, 227, 158, 143, 178, 231, 159, 176, 244, 213, 146, 141, 129, 149, 237, 172, 159, 245, 136, 93, 185, 159, 250, 8, 64, 209, 242, 191, 79, 126, 163, 196, 110, 117, 2, 89, 116, 181, 200, 208, 10, 73, 92, 70, 110, 235, 124, 197 },
                            UserName = "admin"
                        });
                });
            ...
            modelBuilder.Entity("Domain.Entities.UserOperationClaim", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("7c62bfd1-b454-4e2b-a66e-fa55c47cf46d"),
                            CreatedDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            OperationClaimId = 1,
                            UserId = new Guid("5846b2bb-0ca1-4349-bcb1-634795a5aa33")
                        });
                });
